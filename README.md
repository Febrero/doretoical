...
`last.yaml` y `last.ics` tiene los eventos del mes en curso y el siguiente si esta disponible. Sincronizado a `last.ics` se puede consultar esta [vita web](https://calendar.google.com/calendar/embed?src=h7o31k23jpu0622leh8pgedrjmupbcq2%40import.calendar.google.com&ctz=Europe/Madrid)
